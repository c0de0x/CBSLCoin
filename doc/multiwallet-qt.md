...
In order to support loading of multiple wallets in CBSL-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is CBSL.cpp.
...
Changes to CBSL.cpp
----------------------
CBSL.cpp is the entry point into CBSL-qt, and as such, will require some minor modifications to provide hooks for
