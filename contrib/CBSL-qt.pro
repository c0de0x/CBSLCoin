...
RESOURCES += src/qt/CBSL.qrc src/qt/CBSL_locale.qrc

TRANSLATIONS += src/qt/locale/CBSL_bg.ts \
                src/qt/locale/CBSL_de.ts \
                src/qt/locale/CBSL_en.ts \
                src/qt/locale/CBSL_es.ts \
                src/qt/locale/CBSL_fi.ts \
                src/qt/locale/CBSL_fr.ts \
                src/qt/locale/CBSL_it.ts \
                src/qt/locale/CBSL_ja.ts \
                src/qt/locale/CBSL_pl.ts \
                src/qt/locale/CBSL_pt.ts \
                src/qt/locale/CBSL_ru.ts \
                src/qt/locale/CBSL_sk.ts \
                src/qt/locale/CBSL_sv.ts \
                src/qt/locale/CBSL_vi.ts \
                src/qt/locale/CBSL_zh_CN.ts \
                src/qt/locale/CBSL_zh_TW.ts
