Contributing to CBSLCoin
============================

The CBSLCoin project operates an open contributor model where anyone is
...
The following applies to code changes to the CBSLCoin project, and is not to be
confused with overall CBSLCoin Network Protocol consensus changes.

Whether a pull request is merged into CBSLCoin rests with the project merge
...
The project leader is the release manager for each CBSLCoin release.
