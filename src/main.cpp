...
#if defined(NDEBUG)
#error "CBSL cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) { nSubsidy = 420000 * COIN; 
	} else if (nHeight <  9999 &&  nHeight > 0)      { nSubsidy = 1 * COIN; 
	} else if (nHeight <= 14999 && nHeight >= 10000) { nSubsidy = 1.25 * COIN; 
	} else if (nHeight <= 21999 && nHeight >= 22000) { nSubsidy = 1.5 * COIN; 
	} else if (nHeight <= 28999 && nHeight >= 29000) { nSubsidy = 1.75 * COIN; 
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    if (nHeight < 150) {  ret = 0;
    } else if (nHeight <=  9999 && nHeight >=   150) { ret = blockValue * 0.80;
    } else if (nHeight <= 14999 && nHeight >= 10000) { ret = blockValue * 0.75; 
	} else if (nHeight <= 21999 && nHeight >= 15000) { ret = blockValue * 0.7;
...
{
    return; // This keCBSL banning nodes, for no logical reason.
    if (howmuch == 0)
        return;
