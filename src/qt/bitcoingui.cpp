...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and CBSL: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CBSL"), this);
    aboutAction->setStatusTip(tr("Show information about CBSL"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CBSL"));
    ...
    openAction->setStatusTip(tr("Open a CBSL: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CBSL help message to get a list with possible CBSL command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CBSL client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CBSL network", "", count));
}
...
{
    QString strTitle = tr("CBSL"); // default title
