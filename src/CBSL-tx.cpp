...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CBSL CBSL-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  CBSL-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded CBSL transaction") + "\n" +
                               "  CBSL-tx [options] -create [commands]   " + _("Create hex-encoded CBSL transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded CBSL transaction
