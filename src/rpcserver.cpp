...
// Copyright (c) 2019 The CBSLCoin Core developers
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CBSL features */
        {"CBSL", "masternode", &masternode, true, true, false},
        {"CBSL", "listmasternodes", &listmasternodes, true, true, false},
        {"CBSL", "getmasternodecount", &getmasternodecount, true, true, false},
        {"CBSL", "masternodeconnect", &masternodeconnect, true, true, false},
        {"CBSL", "masternodecurrent", &masternodecurrent, true, true, false},
        {"CBSL", "masternodedebug", &masternodedebug, true, true, false},
        {"CBSL", "startmasternode", &startmasternode, true, true, false},
        {"CBSL", "createmasternodekey", &createmasternodekey, true, true, false},
        {"CBSL", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"CBSL", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"CBSL", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"CBSL", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"CBSL", "getmasternodescores", &getmasternodescores, true, true, false},
        {"CBSL", "mnbudget", &mnbudget, true, true, false},
        {"CBSL", "preparebudget", &preparebudget, true, true, false},
        {"CBSL", "submitbudget", &submitbudget, true, true, false},
        {"CBSL", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"CBSL", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"CBSL", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"CBSL", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"CBSL", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"CBSL", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"CBSL", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"CBSL", "checkbudgets", &checkbudgets, true, true, false},
        {"CBSL", "mnsync", &mnsync, true, true, false},
        {"CBSL", "spork", &spork, true, true, false},
        {"CBSL", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"CBSL", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use CBSLd, or the -server option to CBSL-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> CBSL-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:28864/\n";
}
